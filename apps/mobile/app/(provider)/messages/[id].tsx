...
export default function ProviderMessageThreadScreen() {
  ...
  const load = useCallback(async () => {
    ...
    setMessages(rows);
    const name = contacts.clients?.find((c) => c.id === id)?.name;
  ...
  return (
    <Screen title={title} subtitle="Client conversation" scroll={false}>
      ...
      <View style={styles.composer}>
        <TextField style={styles.input} placeholder="Reply…" value={draft} onChangeText={setDraft} />
